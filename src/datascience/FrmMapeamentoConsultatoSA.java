...
public class FrmMapeamentoConsultatoSA extends javax.swing.JDialog {

    private java.awt.Frame parent;
    public Controle controle;
    public MapeamentoSA mapeamentoSASelecionada;
    public MapeamentoSA mapeamentoSAAtual;

    public void LimparTela() {
        this.mapeamentoSASelecionada = null;
        this.mapeamentoSAAtual = new MapeamentoSA();
        AtualizarComboEntidadesConsulta();
    ...
    public void atualizaMapeamentos() {
        ...
        if (this.mapeamentoSAAtual.getMapeamentosAtributos() != null) {
            if (this.mapeamentoSAAtual.getMapeamentosAtributos().size() > 0) {
                for (MapeamentoAtributo mapaAtributo : this.mapeamentoSAAtual.getMapeamentosAtributos()) {
    ...
    public void atualizaAtributoConsulta() {

        DefaultTableModel modelAtributo = (DefaultTableModel) this.tblAtributoConsulta.getModel();
        tblAtributoConsulta.getColumnModel().getColumn(1).setWidth(0);
        tblAtributoConsulta.getColumnModel().getColumn(1).setMinWidth(0);
        tblAtributoConsulta.getColumnModel().getColumn(1).setMaxWidth(0);
        modelAtributo.setRowCount(0);

        //ativando controles
        if (this.mapeamentoSAAtual.getConsultaOrigem().getEntidade() != null) {
            if (this.mapeamentoSAAtual.getConsultaOrigem().getEntidade().getAtributos().size() > 0) {
                for (Atributo atributo : this.mapeamentoSAAtual.getConsultaOrigem().getEntidade().getAtributos()) {
        ...
        tblAtributoConsulta.setModel(modelAtributo);
    ...
    public void atualizaAtributoSA() {
        ...
        //ativando controles
        if (this.mapeamentoSAAtual.getEntidadeSADestino().getAtributos().size() > 0) {
            for (Atributo atributo : this.mapeamentoSAAtual.getEntidadeSADestino().getAtributos()) {
                boolean Exists = false;
                for (MapeamentoAtributo mapaAtributo : this.mapeamentoSAAtual.getMapeamentosAtributos()) {
    ...
    public void AtualizarComboEntidadesConsulta() {
        ...
        cbxEntidadeConsulta.setModel(model);
    }
    ...
    public void SetMapeamentoSelecionado(MapeamentoSA mapeamentoSA) {

        this.mapeamentoSASelecionada = mapeamentoSA;
        this.mapeamentoSAAtual = mapeamentoSA.Copia();
        ...
        for (MapeamentoAtributo mapa : mapeamentoSAAtual.getMapeamentosAtributos()) {
    ...
    private void initComponents() {
        ...
        cbxEntidadeConsulta = new javax.swing.JComboBox<>();
        jLabel12 = new javax.swing.JLabel();
        cbxEntidadeSA = new javax.swing.JComboBox<>();
        jScrollPane1 = new javax.swing.JScrollPane();
        tblAtributoConsulta = new javax.swing.JTable();
        ...
        jLabel11.setText("Tabela Consulta:");

        cbxEntidadeConsulta.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cbxEntidadeConsulta.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cbxEntidadeConsultaItemStateChanged(evt);
            }
        });

        jLabel12.setText("Atributo StagingArea:");
        ...
        tblAtributoConsulta.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jScrollPane1.setViewportView(tblAtributoConsulta);
        ...
        jScrollPane2.setViewportView(tblAtributoSA);
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(cbxEntidadeConsulta, javax.swing.GroupLayout.PREFERRED_SIZE, 198, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(cbxEntidadeSA, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cbxEntidadeConsulta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel11)
                    .addComponent(jLabel12)
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (this.mapeamentoSASelecionada != null) {
            controle.getMapeamentosSA().remove(this.mapeamentoSASelecionada);
            this.mapeamentoSASelecionada = null;
            dispose();
        }
    ...
    private void btnAddRelacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddRelacaoActionPerformed
        ...
        if (tblAtributoConsulta.getSelectedRow() >= 0) {
            atributoOrigem = (Atributo) tblAtributoConsulta.getValueAt(tblAtributoConsulta.getSelectedRow(), 1);
        }

        Atributo atributoDestino = null;
        if (tblAtributoConsulta.getSelectedRow() >= 0) {
            atributoDestino = (Atributo) tblAtributoConsulta.getValueAt(tblAtributoConsulta.getSelectedRow(), 1);
        }

        if (this.mapeamentoSAAtual.getMapeamentosAtributos() != null) {
            for (MapeamentoAtributo mapeamentoAtributo : this.mapeamentoSAAtual.getMapeamentosAtributos()) {
        ...
        if (jaExists) {
            ...
            this.mapeamentoSAAtual.getMapeamentosAtributos().add(novoMapeamentoAtributo);
            atualizaMapeamentos();
            atualizaAtributoSA();
            atualizaAtributoConsulta();
    ...
    private void btnDelRelacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelRelacaoActionPerformed
        ...
        if (tblMapeamento.getSelectedRow() >= 0) {
            if (this.mapeamentoSAAtual.getMapeamentosAtributos() != null) {
                this.mapeamentoSAAtual.getMapeamentosAtributos().remove((MapeamentoAtributo) tblMapeamento.getValueAt(tblMapeamento.getSelectedRow(), 1));
            }
            atualizaMapeamentos();
            atualizaAtributoSA();
            atualizaAtributoConsulta();
    ...
    private javax.swing.JComboBox<String> cbxEntidadeConsulta;
    ...
    private javax.swing.JTable tblAtributoConsulta;
