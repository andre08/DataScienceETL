 ...
 * @author Pessoal
 */
public class FrmDimensaoFato extends javax.swing.JDialog {

    /**
     * Creates new form FrmDimensaoFato
     */
    public FrmDimensaoFato(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDimensaoFato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDimensaoFato dialog = new FrmDimensaoFato(new javax.swing.JFrame(), true);
