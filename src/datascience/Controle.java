                    ...
                    if (!JsonObjConsulta.isNull("ENTIDADE")) {
                        ...
                        if (!JsonObjEntidadeConsulta.isNull("ATRIBUTOS")) {
                            ...
                            for (int j = 0; j < JsonArrayAtributoConsulta.length(); j++) {
                                ...
                                atributoConsulta.setControle(JsonObjAtrinbutoConsulta.has("CONTROLE") ? JsonObjAtrinbutoConsulta.getBoolean("CONTROLE"):false);
                ...
                for (int i = 0; i < JsonArrayEntidadeSA.length(); i++) {
                    ...
                    if (!JsonObjEntidadeSA.isNull("ATRIBUTOS")) {
                        ...
                        for (int j = 0; j < JsonArrayAtributoEntidadeSA.length(); j++) {
                            ...
                            atributoEntidadeSA.setControle(JsonObjAtributoEntidadeSA.has("CONTROLE") ? JsonObjAtributoEntidadeSA.getBoolean("CONTROLE"):false);
                ...
                for (int i = 0; i < JsonArrayEntidadeDW.length(); i++) {
                    ...
                    if (!JsonObjEntidadeDW.isNull("ATRIBUTOS")) {
                        ...
                        for (int j = 0; j < JsonArrayAtributoEntidadeDW.length(); j++) {
                            ...
                            atributoEntidadeDW.setControle(JsonObjAtributoEntidadeDW.getBoolean("CONTROLE"));
        ...
        if ((localizarArquivo.getDirectory() != null) && (localizarArquivo.getFile() != null)) {
            ...
            for (Consulta consulta : this.consultas) {
                ...
                for (Atributo atributoConsulta : entidadeConsulta.getAtributos()) {
                    ...
                    JsonObjAtributoEntidadeConsulta.put("CONTROLE", atributoConsulta.getControle());
            ...
            for (Entidade entidadeSA : this.entidadesSA) {
                ...
                if (entidadeSA.getAtributos() != null) {
                    for (Atributo atributoEntidadeSA : entidadeSA.getAtributos()) {
                        ...
                        JsonObjAtributoEntidadeSA.put("CONTROLE", atributoEntidadeSA.getControle());
            ...
            for (Entidade entidadeDW : this.entidadesDW) {
                ...
                if (entidadeDW.getAtributos() != null) {
                    for (Atributo atributoEntidadeDW : entidadeDW.getAtributos()) {
                        ...
                        JsonObjAtributoEntidadeDW.put("CONTROLE", atributoEntidadeDW.getControle());
